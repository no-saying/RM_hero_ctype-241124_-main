...
#ifdef DEBUG
static Val_t *ins_rtt_data;
static int ins_rtt_data_yaw;
static int ins_rtt_data_gy;
static int ins_rtt_data_gx;
static int ins_rtt_data_gz;
#endif // DEBUG
...
attitude_t *INS_Init(void)
{
    ...
    ins_rtt_data = JScopeInit(val_conf);    
    #endif // DEBUG
...
void INS_Task(void)
{
    ...
    if ((count++ % 4) == 0)
    {
        ins_rtt_data_yaw = (int)INS.Yaw*1000;
        ins_rtt_data_gy = (int)INS.Gyro[2]*1000;
        ins_rtt_data_gx = (int)INS.Gyro[0]*1000;
        ins_rtt_data_gz = (int)INS.Gyro[1]*1000;
        JScope_Updata(ins_rtt_data);
        // 250Hz jscope波形
    }
    #endif // DEBUG
