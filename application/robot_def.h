...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 686 // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
...
// 发射参数
#define ONE_BULLET_DELTA_ANGLE 1400    // 发射一发弹丸拨盘转动的距离,由机械设计图纸给出
